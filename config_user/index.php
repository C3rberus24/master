  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<label>Usuario</label>
        	<input type="text" name="" id="u_usuario" class="form-control input-sm" autocomplete="off">
        	<label>Contraseña</label>
        	<input type="text" name="" id="u_contraseña" class="form-control input-sm" autocomplete="off">
        	<label>Género</label>
        	<input type="text" name="" id="u_genero" class="form-control input-sm" autocomplete="off">
        	<label>Rol</label>
        	<input type="text" name="" id="u_rol" class="form-control input-sm" autocomplete="off">
      </div>
