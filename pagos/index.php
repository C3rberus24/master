            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    ";
                        ...
                        $sql2 = "SELECT p.idpagos, p.n_recibo_p, p.monto_p, p.fecha_p, p.periodo_p, dp.id_socio, dp.dui_s FROM pagos AS p INNER JOIN datos_personales AS dp ON p.datos_personales_id_socio=dp.id_socio 
